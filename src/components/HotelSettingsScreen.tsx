...
export const HotelSettingsScreen: React.FC<HotelSettingsScreenProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto px-3 sm:px-4 py-3 pb-28">
      ...
      <div className="bg-gradient-to-br from-amber-500/10 via-red-500/5 to-transparent dark:bg-stone-800 rounded-3xl p-5 border border-amber-500/30 shadow-sm">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-sm text-stone-900 dark:text-white flex items-center gap-2">
                Firebase क्लाउड सिंक (Real-time Cloud Sync)
              ...
              <p className="text-xs text-stone-500 dark:text-stone-400">
                Project ID: <span className="font-mono font-semibold text-stone-800 dark:text-stone-200">hotel-kohinoor-pos</span>
              </p>
            </div>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mt-4 pt-3 border-t border-amber-500/20 text-xs">
          <div className="p-2.5 bg-white/70 dark:bg-stone-900/60 rounded-xl border border-stone-200 dark:border-stone-700">
            <span className="font-bold text-stone-800 dark:text-stone-200 block mb-0.5">टेबल QR लाइव्ह ऑर्डर्स</span>
            <span className="text-[11px] text-stone-500 dark:text-stone-400">ग्राहकांच्या मोबाईलवरून थेट काउंटरवर ऑटो-सिंक</span>
          </div>
          <div className="p-2.5 bg-white/70 dark:bg-stone-900/60 rounded-xl border border-stone-200 dark:border-stone-700">
            <span className="font-bold text-stone-800 dark:text-stone-200 block mb-0.5">क्लाउड बिल बॅकअप</span>
            <span className="text-[11px] text-stone-500 dark:text-stone-400">तयार झालेले सर्व बिल Firestore मध्ये सुरक्षित</span>
          </div>
          <div className="p-2.5 bg-white/70 dark:bg-stone-900/60 rounded-xl border border-stone-200 dark:border-stone-700">
            <span className="font-bold text-stone-800 dark:text-stone-200 block mb-0.5">Firebase Analytics</span>
            <span className="text-[11px] text-stone-500 dark:text-stone-400">G-94HWLKB52M द्वारे सुरक्षित ट्रॅकिंग</span>
          </div>
        </div>
      </div>
    </div>
